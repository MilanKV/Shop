                                ...
                                <div class="column-left col-lg-4">
                                    <div class="image-card h-100">
                                        <div class="body">
                                            ...
                                            <div class="row">
                                                <div class="image">
                                                    <img class="mt-3 w-100" src="https://cdn.pixabay.com/photo/2017/04/20/07/07/add-2244771_960_720.png" alt="product_image">
                                                </div>
                                    ...
                                    <div class="input-card">
                                        <div class="body">
                                            ...
                                            <div class="form-group mb-0">
                                                <textarea id="short_description" name="short_description" class="form-control m-0" cols="30" rows="2" placeholder="Summary" value="{{ old('short_description') }}"></textarea>
                                            </div>

                                            <label for="long_descriptions" class="form-label mt-2 row mt-4">Description</label>
                                            <div class="form-group mb-0">
                                                <textarea id="long_descriptions" name="long_descriptions" class="form-control m-0" cols="30" rows="4" placeholder="Description" value="{{ old('long_descriptions') }}"></textarea>
                                            </div>
                                            ...
                                            <select name="subcategory_id" id="subcategory_id" class="form-control">
                                                ...
                                                @foreach($categories as $subcategory)
                                                    @if (!$subcategory->is_parent && !is_null($subcategory->parent_id))
                                                        <option value='{{$subcategory->id}}' data-parent-id='{{$subcategory->parent_id}}'>{{$subcategory->category_name}}</option>
                                                    @endif
                                                @endforeach
                                            </select>
                                ...
                                <div class="column-right mt-4 col-lg-8 mt-lg-0">
                                    <div class="input-card">
                                        <div class="body">
                                            ...
                                            <div class="form-group mb-0">
                                                <input id="discount_price" name="discount_price" class="form-control default" type="number" min="0" max="100" placeholder="10" value="{{ old('discount_price') }}" required>
                                            </div>
