                                        ...
                                        @foreach($products as $product)
                                            <tr>
                                                    ...
                                                    <div class="d-flex">
                                                        @if($product->image)
                                                            @if(Str::startsWith($product->image, 'http'))
                                                                <img class="image ms-3" src="{{ $product->image }}" alt="{{ $product->image }}">
                                                            @else
                                                                <img class="image ms-3" src="{{ asset('storage/' . $product->image) }}" alt="{{ $product->image }}">
                                                            @endif
                                                        @else
                                                ...
                                                <td class="text-sm">
                                                    ...
                                                    <a href="{{ route('product.edit', ['product' => $product]) }}" data-bs-toggle="tooltip" data-bs-original-title="Edit product">
