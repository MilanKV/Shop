            ...
            <div class="column col-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="d-lg-flex">
                            <div class="title">
                                <h5 class="mb-0">Deactivated Products</h5>
                                <p class="title-description mb-0">Products that are currently unavailable for sale but can be reactivated.</p>
                            </div>
                        ...
                        <div class="table">
                                    ...
                                    <tbody>
                                        @foreach($products as $product)
                                            <tr>
                                                ...
                                                <td class="text-sm">{{ $product->deleted_at }}</td>
                                                <td class="text-sm">
                                                    <a href="{{ route('product.restore', $product->id)}}" class="btn btn-success p-2 rounded" data-bs-toggle="tooltip" data-bs-original-title="Restore product">
                                                    ...
                                                    <form id="deleteForm{{$product->id}}" method="POST" action="{{ route('product.delete-permanent', ['id' => $product->id]) }}" style="display: none;">
                                                        @csrf
                                                        @method('delete')
                                                    </form>
                                                    <a href="#" class="deleteBtn btn btn-danger p-2 rounded" data-id="{{ $product->id }}" data-bs-toggle="tooltip" data-bs-original-title="Permanent Deletes">
                            ...
                            @else
                                <div class="no-item-found d-flex justify-content-center align-items-center">
                                    <p class="text-center">No deactivated products were found.</p>
                                </div>
                            @endif
                        </div>
                    </div>
