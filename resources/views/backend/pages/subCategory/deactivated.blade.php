                    ...
                    <div class="card-body px-0 pb-0">
                        <div class="table">
                            ...
                            <div class="dataTable-body">
                                <table id="subcategory-list" class="table table-flush">
                                    <thead>
                                        <th data-sortable>
                                    ...
                                    <tbody>
                                        @foreach($categories as $category)
                                            <tr>
                                                ...
                                                <td class="text-sm">
                                                    <a href="{{ route('subcategory.restore', $category->id)}}" class="btn btn-success p-2 rounded" data-bs-toggle="tooltip" data-bs-original-title="Restore subcategory">
                                                    ...
                                                    <form id="deleteForm{{$category->id}}" method="POST" action="{{ route('subcategory.delete-permanent', ['id' => $category->id]) }}" style="display: none;">
                                                        @csrf
                                                        @method('delete')
                                                    </form>
                            ...
                            @else
                                <div class="no-item-found d-flex justify-content-center align-items-center">
                                    <p class="text-center">No deactivated subcategories were found.</p>
                                </div>
                            @endif
                        </div>
                    </div>
