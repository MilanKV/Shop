                    ...
                    <div class="card-header pb-0">
                        <div class="d-lg-flex">
                            ...
                            <div class="card-action my-auto mt-4 ms-auto mt-lg-0">
                                <a href="#" class="btn btn-add mb-0">New User</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body px-0 pb-0">
                        <div class="table">
                                    ...
                                    <tbody>
                                        @foreach($users as $user)
                                            <tr>
                                                ...
                                                <td class="text-sm">
                                                    <a href="#" data-bs-toggle="tooltip" data-bs-original-title="Edit user">
                                                    ...
                                                    <form id="deleteForm{{$user->id}}" method="POST" action="#" style="display: none;">
                                                        @csrf
                                                        @method('delete')
                                                    </form>
                            ...
                            <div class="dataTable-footer">
                                <div class="info">Showing {{ $users->firstItem() }} to {{ $users->lastItem() }} of {{ $users->total() }} entries</div>
