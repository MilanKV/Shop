            ...
            <div class="column col-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="d-lg-flex">
                            <div class="title">
                                <h5 class="mb-0">Deactivated Users</h5>
                                <p class="title-description mb-0">View and manage users whose accounts are deactivated</p>
                            </div>
                                    ...
                                    <tbody>
                                        @foreach($users as $user)
                                            <tr>
                                                ...
                                                <td class="text-sm">{{ $user->deleted_at }}</td>
                                                <td class="text-sm">
                                                    <a href="{{ route('user.restore', $user->id)}}" class="btn btn-success p-2 rounded" data-bs-toggle="tooltip" data-bs-original-title="Restore User">
                                                    ...
                                                    <form id="deleteForm{{$user->id}}" method="POST" action="{{ route('user.delete-permanent', ['id' => $user->id]) }}" style="display: none;">
                                                        @csrf
                                                        @method('delete')
                                                    </form>
                                                    <a href="#" class="deleteBtn btn btn-danger p-2 rounded" data-id="{{ $user->id }}" data-bs-toggle="tooltip" data-bs-original-title="Permanent Deletes">
