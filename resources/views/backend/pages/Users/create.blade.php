                                    ...
                                    <div class="input-card">
                                        <div class="body">
                                            ...
                                            <div class="form-group mb-0">
                                                <input id="name" name="name" class="form-control default" type="text" placeholder="Your Name" value="{{ old('name') }}" required>
                                            </div>

                                            <label for="email" class="form-label mt-2 row mt-4">Email</label>
                                            <div class="form-group mb-0">
                                                <input id="email" name="email" class="form-control default" type="email" placeholder="Your Email" value="{{ old('email') }}" required>
                                            </div>
                                            ...
                                            <div class="form-group mb-0">
                                                <input id="password" name="password" class="form-control default" type="password" placeholder="Password" required>
                                            </div>

                                            <label for="password-confirm" class="form-label mt-2 row mt-4">Confirm Password</label>
                                            <div class="form-group mb-0">
                                                <input id="password-confirm" name="password_confirmation" class="form-control default" type="password" placeholder="Confirm Password" required>
                                            </div>
