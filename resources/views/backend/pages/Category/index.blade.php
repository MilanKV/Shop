            ...
            <div class="column col-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="d-lg-flex">
                            <div class="title">
                                <h5 class="mb-0">All Categorys</h5>
                    ...
                    <div class="card-body px-0 pb-0">
                        <div class="table">
                            <div class="dataTable-header">
                                <div class="dropdown">
                                    <label for="#">
                                        <select class="dataTable-select" name="#" id="#">
                            ...
                            <div class="dataTable-body">
                                <table id="product-list" class="table table-flush">
                                    <thead>
                                        ...
                                        <th data-sortable>
                                            <a href="#" class="dataTable-sorter">Belongs</a>
                                        </th>
                                        <th data-sortable>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-sm">
                                                    ...
                                                    {{-- <form method="POST" action="{{route('category.destroy',[$category->id])}}">
                                                        @csrf
                                                        @method('delete')
                                                            <button class="btn" data-id={{$category->id}} data-toggle="tooltip" title="Delete">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 448 512" fill="#344767">
                                                    ...
                                                    <a href="#" class="deleteBtn" data-id="{{ $category->id }}" data-bs-toggle="tooltip" data-bs-original-title="Delete product">
