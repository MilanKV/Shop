            ...
            <div class="column col-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="d-lg-flex">
                            <div class="title">
                                <h5 class="mb-0">Deactivated Categories</h5>
                                <p class="title-description mb-0">Categories that are currently inactive but can be reactivated at any time.</p>
                            </div>
                    ...
                    <div class="card-body px-0 pb-0">
                        <div class="table">
                            ...
                            <div class="dataTable-body">
                                <table id="category-list" class="table table-flush">
                                    <thead>
                                        <th data-sortable>
                                    ...
                                    <tbody>
                                        @foreach($categories as $category)
                                            <tr>
                                                ...
                                                <td class="text-sm">{{ $category->deleted_at }}</td>
                                                <td class="text-sm">
                                                    <a href="{{ route('category.restore', $category->id)}}" class="btn btn-success p-2 rounded" data-bs-toggle="tooltip" data-bs-original-title="Restore category">
                                                    ...
                                                    <form id="deleteForm{{$category->id}}" method="POST" action="{{ route('category.delete-permanent', ['id' => $category->id]) }}" style="display: none;">
                                                        @csrf
                                                        @method('delete')
                                                    </form>
                                                    <a href="#" class="deleteBtn btn btn-danger p-2 rounded" data-id="{{ $category->id }}" data-bs-toggle="tooltip" data-bs-original-title="Permanent Deletes">
                            ...
                            @else
                                <div class="no-item-found d-flex justify-content-center align-items-center">
                                    <p class="text-center">No deactivated categorys were found.</p>
                                </div>
                            @endif
                        </div>
                    </div>
