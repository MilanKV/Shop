                    ...
                    <div class="card-header pb-0">
                        <div class="d-lg-flex">
                            ...
                            <div class="card-action my-auto mt-4 ms-auto mt-lg-0">
                                <a href="#" class="btn btn-add mb-0">New Brand</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body px-0 pb-0">
                        <div class="table">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-sm">
                                                    <div class="action-btn">
                                                        <a href="#" data-bs-toggle="tooltip" data-bs-original-title="Edit brand">
                            ...
                            <div class="dataTable-footer">
                                <div class="info">Showing {{ $brands->firstItem() }} to {{ $brands->lastItem() }} of {{ $brands->total() }} entries</div>
