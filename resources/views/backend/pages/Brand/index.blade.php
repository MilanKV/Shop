                    ...
                    <div class="card-header pb-0">
                        <div class="d-lg-flex">
                            ...
                            <div class="card-action my-auto mt-4 ms-auto mt-lg-0">
                                ...
                                <a href="{{ route('brand.deactivated') }}" class="btn btn-outline mb-0">Deactivated</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body px-0 pb-0">
                        <div class="table">
                            <div class="dataTable-header">
                                ...
                                @include('backend.partials.search-bar', ['searchRoute' => route('brand.index'), 'search' => $search])
                            </div>
                            @if(count($brands)>0)
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        @endif
                                                        <h6 class="my-auto ms-3">{{ $brand->brand_name }}</h6>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="text-sm">
                                                    <div class="action-btn">
                                                        <a href="{{ route('brand.edit', ['brand' => $brand]) }}" data-bs-toggle="tooltip" data-bs-original-title="Edit brand">
                                                        ...
                                                        <form id="deleteForm{{$brand->id}}" method="POST" action="{{ route('brand.destroy', $brand->id) }}" style="display: none;">
                                                            @csrf
                                                            @method('delete')
                                                        </form>
                                                        <a href="#" class="deleteBtn" data-id="{{ $brand->id }}" data-bs-toggle="tooltip" data-bs-original-title="Delete brand">
                            ...
                            @include('backend.partials.pagination', ['items' => $brands])
                            @else
