            ...
            <div class="column col-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="d-lg-flex">
                            <div class="title">
                                <h5 class="mb-0">Add a new brand</h5>
                            </div>
                                ...
                                <div class="column-left col-lg-4">
                                    <div class="image-card h-100">
                                        <div class="body">
                                            ...
                                            <div class="row">
                                                <div class="image">
                                                    <img class="mt-3 w-100" src="https://cdn.pixabay.com/photo/2017/04/20/07/07/add-2244771_960_720.png" alt="brand_image">
                                                </div>
                                    ...
                                    <div class="input-card">
                                        <div class="body">
                                            ...
                                            <div class="form-group mb-0">
                                                <input id="brand_name" name="brand_name" class="form-control default" type="text" placeholder="Brand Name" value="{{ old('brand_name') }}" required>
                                            </div>
